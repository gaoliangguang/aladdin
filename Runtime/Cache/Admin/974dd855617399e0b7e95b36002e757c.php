     ...
     <div class="table-responsive">
        <div class="dataTables_wrapper">  
            ...
            <div class="row">
                <div class="col-sm-12">
                     <label>
                            <a class="btn btn-sm btn-primary" href="<?php echo U('Supplier/addPostage');?>"><i class="icon-plus"></i>新增运费模板</a>
                        </label>
                </div>
            </div>
            ...
            <table class="table table-striped table-bordered table-hover dataTable">
				...
				<?php if(!empty($list)): if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$menu): $mod = ($i % 2 );++$i;?><tr>
                        ...
                        <td></td>
                        <td>
                            <a title="编辑" href="" class="ui-pg-div ui-inline">
                                编辑
                            </a>
                            <a title="删除" href="" class="ui-pg-div ui-inline confirm ajax-get">
                                删除
                            </a>
                        </td>
