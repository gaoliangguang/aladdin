                ...
                <div class="col-sm-12">
                    <form class="search-form">
                        <label>
			                ...
			                <label>
                            	<a class="btn btn-sm btn-primary" style="margin-top:5px;" href="<?php echo U('Supplier/addArea');?>"><i class="icon-plus"></i>新建指定地区</a>
                        	</label>
                            <input type="text" style="height:35px;margin-top:20px; " class="search-input" name="title" value="<?php echo I('title');?>" placeholder="地区">
                        </label>
                        <label>
                            <button class="btn btn-sm btn-primary" type="button" style="margin-top:15px;" id="search" url="<?php echo U('index');?>">
