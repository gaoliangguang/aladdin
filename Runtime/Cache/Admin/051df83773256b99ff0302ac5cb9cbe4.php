    ...
    <body class="skin-2">
     ...
     <div class="table-responsive">
        <div class="dataTables_wrapper">  
            编辑运费模板
            <form id="form" action="<?php echo U('editFreight');?>" method="post" class="form-horizontal">
					...
					<div id="tab1" class="tab-pane active tab1">
			                ...
			                <div class="form-group">			                	
			                    ...
			                    <div class="col-xs-12 col-sm-6">		                    	
			                        <input type="text" class="width-100" name="firstFreight" value="<?php echo ($info["firstfreight"]); ?>">	
			                    </div>
			                ...
			                <div class="form-group">
			                    ...
			                    <div class="col-xs-12 col-sm-6">
			                        <input type="text" class="width-100" name="secFreight" value="<?php echo ($info["secfreight"]); ?>">                    
			                    </div>
			                    <div class="help-block col-xs-12 col-sm-reset inline">
			                    </div>
			                </div>                
			                <div class="form-group">
			                    ...
			                    <div class="col-xs-12 col-sm-6">
			                        <input type="text" class="width-100" name="freightName" value="<?php echo ($info["freightname"]); ?>">                    
			                    </div>
			                    <div class="help-block col-xs-12 col-sm-reset inline">
			                    </div>
			                </div>            
			                <div class="form-group">
			                    ...
			                    <div class="col-xs-12 col-sm-6">
			                        <select name="freightType">
			                            ...
			                            <option value="NOT" <?php if( $info["freighttype"] == 'NOT'): ?>selected="selected"<?php endif; ?> >包邮</option>
			                            <option value="NOE" <?php if( $info["freighttype"] == 'NOE'): ?>selected="selected"<?php endif; ?> >包邮（指定地区除外）</option>
			                            <option value="BUY" <?php if( $info["freighttype"] == 'BUY'): ?>selected="selected"<?php endif; ?> >运费到付</option>
			                            <option value="NAT" <?php if( $info["freighttype"] == 'NAT'): ?>selected="selected"<?php endif; ?> >全国统一价</option>
			                            <option value="NAE" <?php if( $info["freighttype"] == 'NAE'): ?>selected="selected"<?php endif; ?> >全国统一价（指定地区除外）</option>
