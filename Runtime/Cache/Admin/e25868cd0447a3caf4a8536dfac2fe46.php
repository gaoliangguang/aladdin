            ...
            <form id="form" action="/aladdin/root/admin.php?s=/config/addfeerate.html" method="post" class="form-horizontal">
			    <div class="tab-content no-border padding-24">
					...
					<div id="tab1" class="tab-pane active tab1">
			                <div class="form-group">
			                    ...
			                    <div class="col-xs-12 col-sm-6">
			                        <select name="type" style="width: 300px;">
			                            <option value="BZJ" selected="">广东省</option>
			                            <option value="TX#">海南省</option>
			                            <option value="BZJ">福建省</option>
			                            <option value="BZJ">广西省</option>
			                        </select><br/><br/>
			                        <select name="type" style="width: 300px;">
			                ...
			                <div class="form-group">
			                    <label class="col-xs-12 col-sm-2 control-label no-padding-right">是否包邮</label>
			                    <div class="col-xs-12 col-sm-6">
			                       <label>
