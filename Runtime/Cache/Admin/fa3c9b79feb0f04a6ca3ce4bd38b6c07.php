			    ...
			    <div class="tab-content no-border padding-24">
					...
					<div id="tab1" class="tab-pane active tab1">
			                <div class="form-group">
			                    <label class="col-xs-12 col-sm-2 control-label no-padding-right"><span style="color: red;">*</span>首重（元，1kg以内）</label>
			                    <div class="col-xs-12 col-sm-6">
			                        <input type="text" class="width-100" name="min_amount" value="">                    </div>
			                    <div class="help-block col-xs-12 col-sm-reset inline">
			                    </div>
			                </div>                
			                <div class="form-group">
			                    <label class="col-xs-12 col-sm-2 control-label no-padding-right"><span style="color: red;">*</span>续重（元/kg）</label>
			                    <div class="col-xs-12 col-sm-6">
			                ...
			                <div class="form-group">
			                    <label class="col-xs-12 col-sm-2 control-label no-padding-right"><span style="color: red;">*</span>模板名称</label>
			                    <div class="col-xs-12 col-sm-6">
			                ...
			                <div class="form-group">
			                    ...
			                    <div class="col-xs-12 col-sm-6">
			                        <select name="type">
			                            <option value="BZJ" selected="">包邮</option>
			                            <option value="TX#">包邮，指定地区除外</option>
			                            <option value="BZJ">全国统一</option>
			                            <option value="BZJ">全国统一，指定地区除外</option>
			                        </select>                    </div>
			                    <div class="help-block col-xs-12 col-sm-reset inline">
			                    </div>
			                </div>        
