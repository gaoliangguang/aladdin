...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="/aladdin/root/Public/Ace/css/bootstrap.min.css" rel="stylesheet" />
                ...
                <div class="row">
                    <div class="col-sm-10 col-sm-offset-1">
                        <div class="login-container">
                            <div class="center">
                                <h1>
                                    <img alt="" src="/aladdin/root/Public/Admin/images/login_logo.png" style="margin-bottom: 6px;">
...
<!--                                         </div> -->
    ...
    <script type="text/javascript">
		...
		$(function(){
            ...
            var src = '/aladdin/root/Public/Ace/images/background/'+list[ranNum];
            $.get(src,function(){
